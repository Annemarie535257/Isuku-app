...
echo ""
echo "   mkdir -p /opt/render/project/src/AI_Chatbot/models/isuku_chatbot_llama"
echo "   # Then use 'scp' or Render's file upload feature"
echo ""
echo "Option 2: Use SCP (if you have SSH access)"
echo "   scp -r $MODEL_DIR/*.safetensors $MODEL_DIR/*.json $MODEL_DIR/*.jinja user@render:/opt/render/project/src/AI_Chatbot/models/isuku_chatbot_llama/"
echo ""
